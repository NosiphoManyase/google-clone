...
function HomeSearch() {
    ...
    const [loadingRandomSearch, setLoadingRandomSearch] = useState('')
  ...
  return (
    <>
        ...
        sm:space-x-4 justify-center sm:flex-row mt-8'>
            ...
            <button disabled={loadingRandomSearch} onClick={randomSearch} 
            className='btn flex items-center justify-center disabled:opacity-80'>
             {loadingRandomSearch? <img src='spinner.svg' alt='loading...'
             className='h-6 text-center'/> : "I'm Feeling Lucky"} 
            </button>
        </div>
    </>
  )
